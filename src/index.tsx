import { IEezStudio, IRunningFlow, PropertyType, ProjectType } from "eez-studio-types";
...
const extension = {
    eezFlowExtensionInit: (eezStudio: IEezStudio) => {
        ...
        ////////////////////////////////////////////////////////////////////////////////
        class TemplateActionComponent extends ActionComponent {
        ...
        registerClass(TemplateActionComponent);
        ////////////////////////////////////////////////////////////////////////////////
    }
};
